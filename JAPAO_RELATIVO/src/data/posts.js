// Dados extraídos do portal — adicione novos posts aqui
...
export const posts = Object.entries(DB).map(([id, data]) => ({ id, ...data }));

export function getExcerpt(htmlStr, maxLen = 110) {
